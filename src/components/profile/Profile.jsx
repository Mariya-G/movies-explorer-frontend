    ...
    <form className="profile__form">
      <div className="profile__row">
        ...
        <input className="profile__input profile__input_line" type="text" 
          id="name" placeholder="Введите Имя" value="Виталий" name="name" minLength="2" maxLength="40"
        />
      </div>
      <div className="profile__row">
        <label className="profile__subtitle">E-mail</label>
        <input className="profile__input" type="text" 
          id="email"  placeholder="Введите Email" value="admin@yandex.ru" name="email" minLength="2" maxLength="40"
        />
      </div>
      <button
